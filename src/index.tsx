        ...
        <div id="userManagementSection" class="hidden mb-8">
          <div class="bg-white rounded-lg shadow-sm">
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              ...
              <div class="flex gap-2">
                <button onclick="if(window.testDatabaseConnection) window.testDatabaseConnection(); else alert('함수가 로드되지 않았습니다. 페이지를 새로고침해주세요.');" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
