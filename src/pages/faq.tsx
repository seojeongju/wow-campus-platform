...
export function handler(c: Context) {
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "메인 페이지 우측 상단의 '회원가입' 버튼을 클릭하세요. 구직자, 기업, 에이전트 중 원하는 유형을 선택하고 필요한 정보를 입력하면 됩니다."
        }
      },
      {
        "@type": "Question",
        "name": "외국인 비자 지원이 가능한가요?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "네, 저희 플랫폼의 many 기업들이 외국인 비자 지원을 제공합니다. 구인공고에서 '비자 지원' 필터를 사용하여 해당 기업들을 찾아보세요."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "네, 현재 베타 서비스 기간으로 구인공고 등록이 완전 무료입니다. 무제한 공고 등록과 이력서 열람이 가능합니다."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "현재 베타 서비스 기간으로 모든 기본 기능이 무료입니다. 정식 서비스 출시 시 요금제가 도입될 예정이며, 사전에 공지해드립니다."
        }
      }
    ]
  };
  ...
  return c.render(
    ...
    {
      title: "자주 묻는 질문(FAQ) | WOW-CAMPUS",
      description: "WOW-CAMPUS 플랫폼 이용, 외국인 취업 비자 지원, 구인공고 등록 등 궁금한 사항에 대한 답변을 확인하세요.",
      jsonLd: jsonLd
    }
  );
}
