...
export const handler = (c: Context) => {
  ...
  return c.render(
    ...
    {
      title: '협약대학교 안내 | WOW-CAMPUS - 외국인 유학 파트너 대학교',
      description: '외국인 유학생을 위한 한국 협약대학교 목록. 어학연수, 학부, 대학원 과정. 지역별, 전공별, 학위 과정별 검색. WOW-CAMPUS 파트너 대학교에서 한국 유학을 시작하세요.',
      keywords: '협약대학교, 외국인 유학, 한국 대학교, 어학연수 대학, 학부 입학, 대학원 입학, 외국인 유학생',
    }
  )
}
