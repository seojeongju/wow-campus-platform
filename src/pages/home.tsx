...
export const handler = (c: Context) => {
  ...
  return c.render(
    ...
    {
      title: 'WOW-CAMPUS | 외국인 취업·유학 통합 플랫폼 - 한국 취업·유학 NO.1',
      description: '외국인을 위한 한국 취업정보, 유학 정보, AI 매칭 서비스. 구인·구직·대학교 입학까지 한 번에 해결하세요. 서울, 구미, 전주 오피스 운영.',
      keywords: '외국인 취업, 한국 취업, 외국인 유학, 비자 지원, 구인구직, E7비자, 한국어 교육, wow-campus, 외국인 채용',
    }
  )
}
