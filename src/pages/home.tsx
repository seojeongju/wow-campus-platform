...
export const handler = (c: Context) => {
  ...
  return c.render(
    ...
    {
      title: '한국 외국인 취업·유학 No.1 WOW-CAMPUS | E-7비자·AI매칭·구인구직 무료',
      description: '외국인 한국 취업·유학 No.1 플랫폼. E-7 비자·E-9 비자·고용허가제·숙련기능인력 정보 제공. AI 스마트매칭으로 나에게 맞는 일자리를 찾아보세요. 서울·구미·전주 오피스 운영.',
      keywords: '외국인 취업, 한국 취업, E-7 비자, E-9 비자, 고용허가제, 숙련기능인력, 외국인 구인구직, AI 매칭, 한국 유학, 외국인 일자리, wow-campus',
    }
  )
}
