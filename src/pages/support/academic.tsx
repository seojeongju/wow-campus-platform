    ...
    <div class="min-h-screen bg-gray-50">
      ...
      <main class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 mb-8"><div class="flex flex-wrap gap-2">
          ...
          <a href="/support/academic" class="px-4 py-2 rounded-lg font-medium bg-indigo-600 text-white">학업/진로</a>
          <a href="/support/employment" class="px-4 py-2 rounded-lg font-medium bg-gray-100 text-gray-700 hover:bg-gray-200">취업 지원</a>
        </div></div>
