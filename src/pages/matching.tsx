...
export function handler(c: Context) {
  ...
  return c.render(
    ...
    {
      title: 'AI 스마트매칭 | WOW-CAMPUS - 외국인 취업 AI 매칭 서비스',
      description: '외국인 구직자와 기업을 연결하는 AI 스마트매칭 서비스. 기술·지역·비자·경력을 분석하여 최적의 취업 기회를 제안합니다. WOW-CAMPUS AI 매칭으로 취업 성공률을 높이세요.',
      keywords: 'AI 매칭, 스마트매칭, 외국인 취업 매칭, 인재 매칭, 구직 매칭, 취업 AI, 외국인 채용 매칭',
    }
  )
}
