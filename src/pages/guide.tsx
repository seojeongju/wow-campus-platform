...
export function handler(c: Context) {
  return c.render(
    ...
    {
      title: '이용가이드 | WOW-CAMPUS - 외국인 취업·유학 서비스 사용법',
      description: 'WOW-CAMPUS 서비스 이용 방법 안내. 구직자 가이드, 기업 가이드, AI 스마트매칭 활용법, 프로필 최적화 팁 등 성공적인 구직 활동을 위한 상세 가이드.',
      keywords: '이용가이드, 사용법, 구직자 가이드, 기업 가이드, AI 매칭, 취업가이드, wow-campus 사용법',
    }
  )
}
