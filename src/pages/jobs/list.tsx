...
export const handler = async (c: Context) => {
  ...
  return c.render(
    ...
    {
      title: '외국인 한국 구인정보·채용공고 | WOW-CAMPUS - 외국인 일자리 무료검색',
      description: '한국 외국인 채용공고 모음. E-7비자·E-9비자 취업 가능 일자리, 제조업·IT·서비스·건설업 외국인 구인정보. WOW-CAMPUS AI 매칭으로 나에게 맞는 취업 기회를 찾으세요.',
      keywords: '외국인 구인정보, 외국인 채용, 외국인 일자리, E-7 비자 채용, E-9 비자 취업, 제조업 외국인, IT 외국인 채용, 한국 취업공고, 外国人 求人',
    }
  )
}
