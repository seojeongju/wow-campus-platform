...
export const handler = (c: Context) => {
  ...
  return c.render(
    ...
    {
      title: '외국인 유학 프로그램 | WOW-CAMPUS - 한국 어학연수·학부·대학원',
      description: '외국인을 위한 한국 유학 정보. 어학연수, 학부과정, 대학원 입학 컨설팅. 협약대학교 장학금 및 기숙사 지원. WOW-CAMPUS에서 한국 유학을 시작하세요.',
      keywords: '외국인 유학, 한국 유학, 어학연수, 학부 입학, 대학원 입학, 장학금, 외국인 대학교육',
    }
  )
