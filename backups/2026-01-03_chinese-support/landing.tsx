      ...
      <div class="absolute top-6 right-6 z-50">
        <div class="relative group">
          ...
          <div class="absolute top-full right-0 mt-2 w-32 bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
            ...
            <a href="?lang=vi" onclick="document.cookie='app_lang=vi; path=/; max-age=31536000'; window.location.reload(); return false;" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">Tiếng Việt</a>
            <a href="?lang=zh" onclick="document.cookie='app_lang=zh; path=/; max-age=31536000'; window.location.reload(); return false;" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">中文</a>
          </div>
        </div>
      </div>
