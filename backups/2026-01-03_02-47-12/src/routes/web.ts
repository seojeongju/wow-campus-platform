...
web.get('/dashboard/admin', authMiddleware, requireAdmin, DashboardAdminPage)
...
// Test Upload
web.get('/test-upload.html', async (c) => {
    try {
        const html = '<h1>Test Upload</h1>';
        return c.html(html)
    } catch (e) {
