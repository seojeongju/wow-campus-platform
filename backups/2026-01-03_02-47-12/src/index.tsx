...
app.get('/test-upload.html', async (c) => {
  // Reading local file might fail in Workers, but kept for dev compatibility as per original
  try {
    const html = '<h1>Test Upload</h1>'; // Placeholder
    return c.html(html)
  } catch (e) {
